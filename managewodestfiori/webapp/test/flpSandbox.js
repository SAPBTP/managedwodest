		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#managewodestfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"managewodestfiori-display": {
								"semanticObject": "managewodestfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=managewodestfiori",
									"url": sap.ui.require.toUrl("managewodestfiori")
								}
							}
						}
					}
